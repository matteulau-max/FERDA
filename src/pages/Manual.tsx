    ...
    <div style="background:#fffdf7;border:1px solid rgba(14,58,41,.14);border-radius:14px;box-shadow:0 10px 30px -18px rgba(14,58,41,.55);margin:0 0 18px;overflow:hidden">
      ...
      <div style="padding:6px 18px 8px">
        <ul style="list-style:none;margin:0;padding:0">
          ...
          <li style="padding:14px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;gap:12px"><span style="flex:0 0 76px;font-variant-numeric:tabular-nums;color:#1c5540;font-weight:700;font-size:15px;padding-top:1px">PM</span><span><span style="font-weight:600">Round 4 · New York Country Club <span style="display:inline-block;background:#ece3cb;color:#1c5540;border-radius:999px;padding:2px 10px;font-size:12.5px;letter-spacing:.04em;font-weight:600;margin-left:6px;vertical-align:middle">1v1 Singles</span><span style="display:inline-block;background:#e1ede4;color:#1c5540;border:1px solid #b9d3c1;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;font-weight:700;padding:2px 8px;border-radius:6px;margin-left:6px">Match Play</span></span><span style="display:block;font-size:14px;color:#5d6b5f;margin-top:2px">Tee times 2:30 / 2:40 / 2:50 / 3:00 / 3:10 PM · $120 per person · range included</span></span></li>
  ...
  rules: `<p style="font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:20px;line-height:1.4;text-align:center;color:#1c5540;margin:6px 8px 22px">These rules govern all competitive play during The Ferda Invitational. All participants are expected to know and abide by them. The Commissioner's rulings are final.</p>
    ...
    <div style="background:#fffdf7;border:1px solid rgba(14,58,41,.14);border-radius:14px;box-shadow:0 10px 30px -18px rgba(14,58,41,.55);margin:0 0 18px;overflow:hidden">
      ...
      <div style="padding:6px 18px 8px"><ul style="list-style:none;margin:0;padding:0">
        <li style="padding:14px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;gap:12px"><span style="color:#bcae5b;font-weight:700;flex:0 0 auto;line-height:1.4">—</span><span><span style="color:#2f7256;font-weight:700">Round 1 — Scramble (2v2).</span> Patriot Hills. <span style="display:inline-block;background:#e1ede4;color:#1c5540;border:1px solid #b9d3c1;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;font-weight:700;padding:2px 8px;border-radius:6px;margin-left:6px">Stroke Play</span></span></li>
        <li style="padding:14px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;gap:12px"><span style="color:#bcae5b;font-weight:700;flex:0 0 auto;line-height:1.4">—</span><span><span style="color:#2f7256;font-weight:700">Round 2 — Best Ball (2v2).</span> Rotella. <span style="display:inline-block;background:#e1ede4;color:#1c5540;border:1px solid #b9d3c1;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;font-weight:700;padding:2px 8px;border-radius:6px;margin-left:6px">Stroke Play</span></span></li>
        <li style="padding:14px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;gap:12px"><span style="color:#bcae5b;font-weight:700;flex:0 0 auto;line-height:1.4">—</span><span><span style="color:#2f7256;font-weight:700">Round 3 — Best Ball (2v2).</span> Patriot Hills. <span style="display:inline-block;background:#e1ede4;color:#1c5540;border:1px solid #b9d3c1;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;font-weight:700;padding:2px 8px;border-radius:6px;margin-left:6px">Match Play</span></span></li>
        <li style="padding:14px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;gap:12px"><span style="color:#bcae5b;font-weight:700;flex:0 0 auto;line-height:1.4">—</span><span><span style="color:#2f7256;font-weight:700">Round 4 — Singles (1v1).</span> New York Country Club. <span style="display:inline-block;background:#e1ede4;color:#1c5540;border:1px solid #b9d3c1;font-size:11.5px;letter-spacing:.05em;text-transform:uppercase;font-weight:700;padding:2px 8px;border-radius:6px;margin-left:6px">Match Play</span></span></li>
  ...
  app: `<p style="font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:20px;line-height:1.4;text-align:center;color:#1c5540;margin:6px 8px 22px">Live scores, win probability, and the full ruleset — in your pocket. No download, no login.</p>
    ...
    <div style="background:#fffdf7;border:1px solid rgba(14,58,41,.14);border-radius:14px;box-shadow:0 10px 30px -18px rgba(14,58,41,.55);margin:0 0 18px;overflow:hidden">
      ...
      <div style="padding:6px 18px 8px"><ul style="list-style:none;margin:0;padding:0">
        ...
        <li style="padding:14px 2px;display:flex;gap:12px"><span style="color:#bcae5b;font-weight:700;flex:0 0 auto;line-height:1.4">—</span><span><span style="color:#2f7256;font-weight:700">Best Golfer</span> ranks the top 5 individuals — weighted 50% match points, 35% net strokes, 15% birdies (Rtg / Pts / Net / Brd).</span></li>
      </ul></div>
    </div>
  ...
  roster: `<p style="font-family:'Playfair Display',Georgia,serif;font-style:italic;font-size:20px;line-height:1.4;text-align:center;color:#1c5540;margin:6px 8px 22px">Every boy, one tap away.</p>
    ...
    <div style="background:#fffdf7;border:1px solid rgba(14,58,41,.14);border-radius:14px;box-shadow:0 10px 30px -18px rgba(14,58,41,.55);margin:0 0 18px;overflow:hidden">
      ...
      <ul style="list-style:none;margin:0;padding:6px 18px 10px">
        ...
        <li style="padding:13px 2px;border-bottom:1px solid rgba(14,58,41,.14);display:flex;justify-content:space-between;align-items:center;gap:10px"><span style="font-weight:600;color:#1c2b22;font-size:16px">Sam O'Neill</span><a href="tel:+13177011854" style="flex:0 0 auto;color:#1c5540;text-decoration:none;font-weight:700;font-size:14px;font-variant-numeric:tabular-nums">(317) 701-1854</a></li>
